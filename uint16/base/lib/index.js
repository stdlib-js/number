...
*/
setReadOnly( ns, 'add', require( './../../../uint16/base/add' ) );
...
*/
setReadOnly( ns, 'identity', require( './../../../uint16/base/identity' ) );
...
*/
setReadOnly( ns, 'mul', require( './../../../uint16/base/mul' ) );
...
*/
setReadOnly( ns, 'sub', require( './../../../uint16/base/sub' ) );
