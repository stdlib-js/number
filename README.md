...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/number@v0.3.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Number, float32, float64, int32, uint16, uint32, uint8 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number@v0.3.1-deno/mod.js';
```
