...
import add = require( './../../../../uint32/base/add' );
import fromBinaryStringUint32 = require( './../../../../uint32/base/from-binary-string' );
import identity = require( './../../../../uint32/base/identity' );
import mul = require( './../../../../uint32/base/mul' );
import muldw = require( './../../../../uint32/base/muldw' );
import rotl32 = require( './../../../../uint32/base/rotl' );
import rotr32 = require( './../../../../uint32/base/rotr' );
import sub = require( './../../../../uint32/base/sub' );
