...
*/
setReadOnly( ns, 'add', require( './../../../uint32/base/add' ) );
...
*/
setReadOnly( ns, 'mul', require( './../../../uint32/base/mul' ) );
...
*/
setReadOnly( ns, 'muldw', require( './../../../uint32/base/muldw' ) );
...
*/
setReadOnly( ns, 'sub', require( './../../../uint32/base/sub' ) );
