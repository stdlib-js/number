...
/**
* Interface for computing the bitwise XOR of two 64-bit unsigned integers.
*/
interface Xor {
	/**
	...
	*
	* var out = xor.assign( 1, 2, 3, 4, new Uint32Array( 2 ), 1, 0 );
	...
	*
	* var out = xor.strided( a, 1, 0, b, 1, 0, new Uint32Array( 2 ), 1, 0 );
	* // returns <Uint32Array>[ 2, 6 ]
	*/
